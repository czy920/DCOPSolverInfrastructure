...
public class MaxsumDampingAgent extends SyncAgent {

    private static final int MAX_CYCLE = 122;
    ...
    public MaxsumDampingAgent(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
