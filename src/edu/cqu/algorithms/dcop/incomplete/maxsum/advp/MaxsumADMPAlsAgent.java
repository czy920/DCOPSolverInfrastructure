...
public class MaxsumADMPAlsAgent extends ALSAgent {
    ...
    public MaxsumADMPAlsAgent(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
        ...
        switch (phase){
            ...
            case PHASE_Q:
                ...
                if (round >= TIMING) {
                    ...
                    int offset = (round - TIMING) % 4;
                    if (offset <= 1){
                        enableValuePropation = false;
                    }
                }
