...
public class MaxsumADAlsAgent extends ALSAgent {
    private static final int MAX_CYCLE = 4560;
    private static final int LONGEST_PATH_LENGTH = 240;
    private static final int TIMING = 1000; //timing = 1000 ad, timing = 2 advp
    ...
    public MaxsumADAlsAgent(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
