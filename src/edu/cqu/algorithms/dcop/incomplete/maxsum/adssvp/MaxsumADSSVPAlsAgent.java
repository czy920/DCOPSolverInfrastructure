...
public class MaxsumADSSVPAlsAgent extends ALSAgent {
    ...
    public MaxsumADSSVPAlsAgent(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
