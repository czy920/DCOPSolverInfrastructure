...
public class MaxsumPVPAgent extends SyncAgent {
    ...
    public MaxsumPVPAgent(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
